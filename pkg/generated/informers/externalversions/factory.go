...
import (
	...
	filesync "git.inspur.com/middleware/idx-component/docker/filesync/idx-ceco/pkg/generated/informers/externalversions/filesync"
...
type SharedInformerFactory interface {
	...
	Idx() filesync.Interface
}

func (f *sharedInformerFactory) Idx() filesync.Interface {
	return filesync.New(f, f.namespace, f.tweakListOptions)
}
